...
public class UserService {
	...
	public UserService(UserRepository userRepository, EmailService emailService, OTPService otpService, AttachmentService attachmentService, APIConfig apiConfig, WebSocketService webSocketService, MemberService memberService) {
	...
	public void setStatus(long userId, int status) throws Exception {
		...
		webSocketService.sendMessageToSessions(recipients, GatewayConstant.Opcode.DISPATCH.ordinal(), new StatusDTO(userId, status), GatewayConstant.Event.USER_STATUS_UPDATE.getValue());
	...
	public User addContact(User user, long id) throws UserContactAlreadyExistException {
		try {
			...
			webSocketService.sendMessageToSessions(Collections.singletonList(contact.getId()), GatewayConstant.Opcode.DISPATCH.ordinal(), new UserDTO(user, null, null, false, false, false), GatewayConstant.Event.CONTACT_ADD.getValue());
	...
	public void deleteContact(User user, long id) throws UserContactNotFoundException {
		try {
			...
			webSocketService.sendMessageToSessions(Collections.singletonList(contact.getId()), GatewayConstant.Opcode.DISPATCH.ordinal(), new UserDTO(user, null, null, false, false, false), GatewayConstant.Event.CONTACT_DELETE.getValue());
