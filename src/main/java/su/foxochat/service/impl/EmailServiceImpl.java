...
import su.foxochat.config.EmailConfig;
import su.foxochat.constant.EmailConstant;
import su.foxochat.service.OTPService;
import su.foxochat.util.StringUtils;
...
@Slf4j
@Service
public class EmailServiceImpl implements su.foxochat.service.EmailService {
