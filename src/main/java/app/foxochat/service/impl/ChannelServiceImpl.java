...
public class ChannelServiceImpl implements ChannelService {
	...
	@Override
	public Channel add(User user, long partnerId, ChannelCreateDTO body) throws ChannelAlreadyExistException, UserNotFoundException {
		Channel channel;
	...
	public Channel update(Member member, Channel channel, ChannelEditDTO body) throws Exception {
		if (!member.hasAnyPermission(MemberConstant.Permissions.OWNER, MemberConstant.Permissions.ADMIN, MemberConstant.Permissions.MANAGE_MESSAGES))
		...
		gatewayService.sendMessageToSpecificSessions(getRecipients(channel), GatewayConstant.Opcode.DISPATCH.ordinal(), new ChannelDTO(channel, null, null, null, null), GatewayConstant.Event.CHANNEL_UPDATE.getValue());
