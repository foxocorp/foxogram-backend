...
public class MessageCannotBeEmpty extends BaseException {
    ...
    public MessageCannotBeEmpty() {
        super(
                ExceptionConstant.Messages.MESSAGE_CANNOT_BE_EMPTY.getValue(),
                MessageCannotBeEmpty.class.getAnnotation(ResponseStatus.class).value(),
                ExceptionConstant.Message.CANNOT_BE_EMPTY.getValue()
        );
    }
}
