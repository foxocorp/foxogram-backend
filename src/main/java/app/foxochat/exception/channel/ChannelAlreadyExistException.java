...
public class ChannelAlreadyExistException extends BaseException {
    ...
    public ChannelAlreadyExistException() {
        super(
                ExceptionConstant.Messages.CHANNEL_ALREADY_EXIST.getValue(),
                ChannelAlreadyExistException.class.getAnnotation(ResponseStatus.class).value(),
                ExceptionConstant.Channel.ALREADY_EXIST.getValue()
        );
    }
}
